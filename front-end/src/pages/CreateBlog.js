...
const CreateBlog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      const Response=await fetch(`${process.env.REACT_APP_BASE_URL}/createBlog`,{
        method:'POST',
        headers: {
  ...
  return (
    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-sky-400 text-3xl my-7 font-semibold'>Create a Blog</h1>
